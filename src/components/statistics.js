...
/* Возвращает неповторяющиеся элементы массива */
const getUniqItems = (item, index, array) => {
  return array.indexOf(item) === index;
};

/* Возвращает подходящие под переданный период задачи */
...
/* Возвращает placeholder периода */
...
/* Отрисовывает график по цветам */
const renderColorsChart = (colorsCtx, tasks) => {
  /* Сохраняет массив неповторяющихся цветов из списка задач */
  const colors = tasks
    .map((task) => task.color)
    .filter(getUniqItems);

  /* Возвращает новый график по заданным настройкам */
...
/* Отрисовывает график по хештегам */
const renderTagsChart = (tagsCtx, tasks) => {
  /* Возвращает массив неповторяющихся хештегов */
...
/* Возвращает шаблон разметки экрана статистики */
...
/* Экспортирует класс (компонент) статистики */
